...
import me.y9san9.lifetime.core.stdlib.combine
...
class CountdownTimeLooper(
    ...
    private fun updateDelay(time: StashedTime): Long {
        val countdownSavedAtMillis = time.countdownSavedAtMillis ?: return 1_000
        val targetTime = countdownSavedAtMillis + 1_000
